...
void generate_main_room(void) {
    ...
    main_room->center_point[0] = x;
    main_room->center_point[1] = y;
...
void clear_room_data(int n) {
    room_data[n].map_info.center_point[0] = -1;
    room_data[n].map_info.center_point[1] = -1;
...
void generate_sub_room(int n) {
    ...
    switch (n) {
        case 0: /*north-central part*/
            ...
            /*north-central room_data(0) not have northern-gate*/
        ...
        case 1: /*north-east part*/
            ...
            /*north-east room_data(1) not have northern-gate & eastern-gate*/
        ...
        case 2: /*middle-east part*/
            ...
            /*middle-east room_data(2) not have eastern-gate*/
        ...
        case 3: /*south-east part*/
            ...
            /*south-east room_data(3) not have southern-gate & eastern-gate*/
        ...
        case 4: /*south-central part*/
            ...
            /*south-central room_data(4) not have southern-gate*/
        ...
        case 5: /*south-west part*/
            ...
            /*south-west room_data(5) not have western-gate & southern-gate*/
        ...
        case 6: /*middle-west part*/
            ...
            /*middle-west room_data(6) not have western-gate*/
        ...
        case 7: /*north-west part*/
            ...
            /*north-west room_data(7) not have northern-gate & western-gate*/
...
void apply_room_to_layer(int n) {
    if (room_data[n].is_exist) {
        ...
        for (int i = room_data[n].map_info.west; i <= room_data[n].map_info.east; ++i) {
            map_layer[room_data[n].map_info.north][i] = map_layer[room_data[n].map_info.south][i] = '-';
        }
        for (int i = room_data[n].map_info.north + 1; i <= room_data[n].map_info.south - 1; ++i) {
            map_layer[i][room_data[n].map_info.west] = map_layer[i][room_data[n].map_info.east] = '|';
        }
    }
}
...
void generate_vertical_path(int n1, int g1, int n2, int g2)
{
    ...
    map_layer[room_data[n1].map_info.gate[g1].y][room_data[n1].map_info.gate[g1].x] =
    map_layer[room_data[n2].map_info.gate[g2].y][room_data[n2].map_info.gate[g2].x] = '+';
    walkable_layer[room_data[n1].map_info.gate[g1].y][room_data[n1].map_info.gate[g1].x] =
    walkable_layer[room_data[n2].map_info.gate[g2].y][room_data[n2].map_info.gate[g2].x] = 1;
    for (int i = room_data[n1].map_info.gate[g1].y + 1; i <= center_point; ++i) {
        map_layer[i][room_data[n1].map_info.gate[g1].x] = '#';
        walkable_layer[i][room_data[n1].map_info.gate[g1].x] = 1;
    }
    for (int i = center_point; i < (room_data[n2].map_info.gate[g2].y); ++i) {
        map_layer[i][room_data[n2].map_info.gate[g2].x] = '#';
        walkable_layer[i][room_data[n2].map_info.gate[g2].x] = 1;
    }
    ...
    for (; x1 <= x2; ++x1) {
        map_layer[center_point][x1] = '#';
        walkable_layer[center_point][x1] = 1;
    }
}
...
void generate_horizontal_path(int n1, int g1, int n2, int g2) {
    ...
    for (int i = room_data[n1].map_info.gate[g1].x + 1; i <= center_point; ++i) {
        map_layer[room_data[n1].map_info.gate[g1].y][i] = '#';
        walkable_layer[room_data[n1].map_info.gate[g1].y][i] = 1;
    }
    for (int i = center_point; i < room_data[n2].map_info.gate[g2].x; ++i) {
        map_layer[room_data[n2].map_info.gate[g2].y][i] = '#';
        walkable_layer[room_data[n2].map_info.gate[g2].y][i] = 1;
    }
    ...
    for (; y1 <= y2; ++y1) {
        map_layer[y1][center_point] = '#';
        walkable_layer[y1][center_point] = 1;
    }
}
...
void generate_angled_path (int n1, int g1, int n2, int g2) {
    ...
    if (n1 == 0 && n2 == 2) {
        map_layer[y1][x2] = '#';
        walkable_layer[y1][x2] = 1;
    } else if (n1 == 4 && n2 == 2) {
        map_layer[y2][x2] = '#';
        walkable_layer[y2][x2] = 1;
    } else if (n1 == 4 && n2 == 6) {
        map_layer[y2][x1] = '#';
        walkable_layer[y2][x1] = 1;
    }
